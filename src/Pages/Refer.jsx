...
const Refer = () => {
  return (<>
    ...
    <div class="flex bg-gray-400 m-5 flex-col rounded-lg py-5 shadow items-center text-white">
      ...
      <div class="relative flex w-full justify-center max-w-[24rem]">
        ...
        <button class="align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-2 px-4 bg-blue-500 text-white shadow-md shadow-blue-500/20 hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none !absolute right-1 top-1 rounded" type="button" id="copyBoard">COPY</button>
      </div>
      <p class="p-5 text-sm">You will get 10% commission on the amount deposited by the person you refer. If your
